                                    ...
                                    <div class="card-body">
                                        <form>
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputEmailAddress" name="inputEmailAddress" type="email" placeholder="Kullanıcı Adınızı Giriniz" />
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputPassword">Parola</label>
                                                <input class="form-control py-4" id="inputPassword" name="===================" type="password" placeholder="Şifrenizi Giriniz" />
                                            </div>
                                            <div class="form-group">
