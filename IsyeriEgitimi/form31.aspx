...
<body>
  ...
  <div class="container-fluid mt-2 border border-dark" id="ust" style="background-color:blue;">
...
<br><br><br><br><br>
        ...
        <div class="container" id="wrapper">
            ...
            <div class="container-fluid border border-dark" id="ogrenci">
                ...
                <div class="row"><div class="col-2 border border-dark basliklar">Anabilim Dalı</div><div class="col-6 border border-dark"></div>
                    <div class="col-4 basliklar border-top border-right border-left border-dark ">Bilim Dalı</div>
                </div>
                <div class="row"><div class="col-2 border border-dark basliklar">Tez Danışmanı</div><div class="col-6 border border-dark"></div>
                ...
                <div ID="tez1" class="container-fluid border border-dark">
                    <div class="row">
                ...
                <div ID="tez2" class="container-fluid border border-dark">
                    <div class="row">
                ...
                <div ID="tez3" class="container-fluid border border-dark">
                    <div class="row">
                ...
                <div ID="tez4" class="container-fluid border border-dark">
                    <div class="row">
                ...
                <div ID="tez5" class="container-fluid border border-dark">
                    <div class="row">
                 ...
                 <div ID="tez6" class="container-fluid border border-dark">
                        <div class="row">
                 ...
                 <div ID="tez7" class="container-fluid border border-dark">
                        <div class="row">
                   ...
                   <div ID="tez8" class="container-fluid border border-dark">
                        <div class="row">
                    ...
                    <div ID="tez9" class="container-fluid border border-dark">
                        <div class="row">
                    ...
                    <div ID="tez10" class="container-fluid border border-dark">
                        <div class="row">
