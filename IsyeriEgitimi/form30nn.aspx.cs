...
{
    public partial class form30nn : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Response.Write("<script>alert('Kaydetme işlemi başarılı...')</script>");
            ...
            {
                Response.Write("<script>alert('Bir hata oluştu.. ("+ hata.Message +")')</script>");
